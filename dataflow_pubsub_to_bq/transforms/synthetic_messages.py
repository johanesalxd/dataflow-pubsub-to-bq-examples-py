...
Generates realistic taxi ride JSON messages at configurable sizes for
use by both local publishers and Dataflow publisher pipelines. All
functions are pure computation with no GCP or broker dependencies.
"""
