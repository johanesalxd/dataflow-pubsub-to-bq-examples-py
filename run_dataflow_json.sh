...
# Dataflow Pub/Sub to BigQuery Pipeline (JSON Column Version)
...
JOB_NAME="dataflow-pubsub-to-bq-json-$(date +%Y%m%d-%H%M%S)"
...
echo "=== Dataflow Pub/Sub to BigQuery Pipeline (JSON Version) ==="
